...
def swagger_auto_schema(method: Optional[str] = None, methods: Optional[List[str]] = None, auto_schema: Optional[Type] = unset, request_body: Optional[Union[_SchemaOrRef, _SerializerOrClass]] = None, query_serializer: Optional[_SerializerOrClass] = None,

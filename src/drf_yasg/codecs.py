...
class _OpenAPICodec(object):
    ...
    def encode_error(self, err: Any) -> Any:
    ...
    def generate_swagger_object(self, swagger: Any) -> Any:
...
class OpenAPICodecJson(_OpenAPICodec):
    ...
    def __init__(self, validators: Any, pretty: bool = False, media_type: str = 'application/json') -> None:
...
YAML_MAP_TAG: str = u'tag:yaml.org,2002:map'


class SaneYamlDumper(yaml.SafeDumper):
    """YamlDumper class usable for dumping ``OrderedDict`` and list instances in a standard way."""

    def ignore_aliases(self, data: Any) -> Any:
        """Disable YAML references."""
        return True

    def increase_indent(self, flow: bool = False, indentless: bool = False, **kwargs: Any) -> Any:
    ...
    def represent_odict(self, mapping: Any, flow_style: Optional[Any] = None) -> Any:  # pragma: no cover
...
def yaml_sane_dump(data: Any, binary: Any) -> Any:
...
class SaneYamlLoader(yaml.SafeLoader):
    def construct_odict(self, node: Any, deep: bool = False) -> Any:
...
def yaml_sane_load(stream: Any) -> Any:
...
class OpenAPICodecYaml(_OpenAPICodec):
    ...
    def __init__(self, validators: Any, media_type: str = 'application/yaml') -> None:
